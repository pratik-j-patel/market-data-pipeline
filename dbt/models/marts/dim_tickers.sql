...
-- happened?" stg_prices is all fact -- one row per ticker per session of what
-- happened, and not one column saying what AAPL *is*. Everything a dashboard needs to group, filter
